...
class AdminController extends Controller
{
    ...
    */
    ...
    public function dashboardView()
    {
        ...
        sum(CASE WHEN male_female = '0' AND isPendingResident = 0 THEN 1 ELSE 0 END) as males,
        sum(CASE WHEN male_female = '1' AND isPendingResident = 0 THEN 1 ELSE 0 END) as females,
        ...
        sum(CASE WHEN (DATE_FORMAT(FROM_DAYS(DATEDIFF(NOW(), birthday )), '%Y') + 0) >= 60 AND isPendingResident = 0 THEN 1 ELSE 0 END ) as count_of_seniors,
